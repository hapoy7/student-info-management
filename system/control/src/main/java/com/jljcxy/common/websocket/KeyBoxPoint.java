package com.jljcxy.common.websocket;
...
@Slf4j
@Component
@ServerEndpoint("/keybox/point")
public class KeyBoxPoint {
	private AtomicInteger clientCount = new AtomicInteger(0); // 客户端个数
	private static CopyOnWriteArraySet<KeyBoxPoint> clients = new CopyOnWriteArraySet<>();// 客户端对像
