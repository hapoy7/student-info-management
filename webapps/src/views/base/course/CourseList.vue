/*课程不分页列表,作者:张可可,日期:2023-03-08 23:42:07*/
<template>
  <el-dialog :title="title" :visible.sync="show" :close-on-click-modal="false" :close-on-press-escape="false">
    ...
    <el-form :inline="true">
      ...
      <el-form-item label="课程类型" v-show="condition.courseType.show" ><el-input placeholder="请输入课程类型" size="mini" v-model="form.courseType"></el-input></el-form-item>
      ...
      <el-form-item label="签到开始时间" v-show="condition.signStime.show" ><el-input placeholder="请输入签到开始时间" size="mini" v-model="form.signStime"></el-input></el-form-item>
      <el-form-item>
      ...
      <div v-if="allShow">
      <el-form-item label="签到结束时间" v-show="condition.signEtime.show" ><el-input placeholder="请输入签到结束时间" size="mini" v-model="form.signEtime"></el-input></el-form-item>
      <el-form-item label="考试开始时间" v-show="condition.examStime.show" ><el-input placeholder="请输入考试开始时间" size="mini" v-model="form.examStime"></el-input></el-form-item>
      <el-form-item label="考试结束时间" v-show="condition.examEtime.show" ><el-input placeholder="请输入考试结束时间" size="mini" v-model="form.examEtime"></el-input></el-form-item>
      </div>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      this.rq.post("/course/list", param).then(res => {
